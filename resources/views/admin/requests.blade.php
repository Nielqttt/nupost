                ...
                <tr>
                    ...
                    <td>
                        <div class="action-wrap">
                            <a href="{{ route('admin.requests.show', $req->id) }}" class="btn-chat" style="text-decoration:none;background:#eff6ff;color:#1d4ed8;border:1px solid #bfdbfe;font-weight:600;">
